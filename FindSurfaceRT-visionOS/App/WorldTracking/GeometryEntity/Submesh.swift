...
extension FloatingPoint {
    static var twoPi: Self { Self(2) * .pi }
    static func radian(fromDegree degree: Self) -> Self { degree * .pi / Self(180) }
    static func degree(fromRadian radian: Self) -> Self { radian * Self(180) / .pi }
}

extension Float {
    static var twoPi: Float { _twoPi }
    static func radian(fromDegree degree: Float) -> Float { degree * _toRadians }
    static func degree(fromRadian radian: Float) -> Float { radian * _toDegrees }
}
